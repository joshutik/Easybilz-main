...
// //                   <Link to={"/member-registration"}> Complete your profile</Link> to personalize your experience.
// //                 </p>
// //                 <div className='mt-4'>
// //                  <Link to={"/member-registration"} className='btn bg-light px-5 fw-bold border-primary rounded-pill complete'>Complete Profile</Link>
// //                 </div>
// //               </div>
// //             </div>
// //           </div>
