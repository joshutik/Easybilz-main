          ...
          <div className="col-lg-12 col-md-12 col-sm-12">
            <div className="container fs-5">
              <div className="card payment-card text-light px-4">
                <p className="pt-2 w-75 mx-auto text-center">
                  Kindly pay to the account number below and call or text us on 
                  <span className="pay-card"> 07037021175</span>, <span className="pay-card">08104263860</span> to confirm.
                </p>
                ...
                <div className="card-body">
                  <p>
                    ...
                    <br />
                    Account Number: <span className="pay-card">0098737021</span>
                    <br />
                    Account Name:{" "}
